...
public interface NetworkDriverServiceStackService {

    @GET("networkDriverServices/{projectId}/stack")
    ...
    @POST("networkDriverServices/{projectId}/stack/{id}?action=finishupgrade")
    Call<Stack> finishupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/stack/{id}?action=remove")
    Call<Stack> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/stack/{id}?action=rollback")
    Call<Stack> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/stack/{id}?action=upgrade")
