...
public interface BackupVolumeService {

    @GET("backups/{projectId}/volume")
    ...
    @POST("backups/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("backups/{projectId}/volume/{id}?action=snapshot")
