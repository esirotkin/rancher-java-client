...
public interface InstanceVolumesService {

    @GET("instances/{projectId}/volume")
    ...
    @POST("instances/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("instances/{projectId}/volume/{id}?action=snapshot")
