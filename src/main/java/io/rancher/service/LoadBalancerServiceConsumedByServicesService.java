...
public interface LoadBalancerServiceConsumedByServicesService {

    @GET("loadBalancerServices/{projectId}/service")
    ...
    @POST("loadBalancerServices/{projectId}/service/{id}?action=cancelupgrade")
    Call<Service> cancelupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=continueupgrade")
    Call<Service> continueupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=deactivate")
    Call<Service> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=finishupgrade")
    Call<Service> finishupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=remove")
    Call<Service> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=removeservicelink")
    ...
    @POST("loadBalancerServices/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("loadBalancerServices/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("loadBalancerServices/{projectId}/service/{id}?action=upgrade")
