...
public interface RegistryVolumesService {

    @GET("registrys/{projectId}/volume")
    ...
    @POST("registrys/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("registrys/{projectId}/volume/{id}?action=snapshot")
