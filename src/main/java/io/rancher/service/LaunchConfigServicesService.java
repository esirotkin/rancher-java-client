...
public interface LaunchConfigServicesService {

    @GET("launchConfigs/{projectId}/service")
    ...
    @POST("launchConfigs/{projectId}/service/{id}?action=upgrade")
