...
public interface AccountVolumesService {

    @GET("accounts/{projectId}/volume")
    ...
    @POST("accounts/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("accounts/{projectId}/volume/{id}?action=snapshot")
