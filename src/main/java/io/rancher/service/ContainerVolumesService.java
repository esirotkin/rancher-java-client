...
public interface ContainerVolumesService {

    @GET("containers/{projectId}/volume")
    ...
    @POST("containers/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("containers/{projectId}/volume/{id}?action=snapshot")
