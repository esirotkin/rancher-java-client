...
public interface ImageVolumesService {

    @GET("images/{projectId}/volume")
    ...
    @POST("images/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("images/{projectId}/volume/{id}?action=snapshot")
