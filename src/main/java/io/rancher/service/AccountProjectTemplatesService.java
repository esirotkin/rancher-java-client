...
public interface AccountProjectTemplatesService {

    @GET("accounts/{projectId}/projectTemplate")
    Call<TypeCollection<ProjectTemplate>> list(@Path("projectId") String projectId);

    @GET("accounts/{projectId}/projectTemplate")
    Call<TypeCollection<ProjectTemplate>> list(@Path("projectId") String projectId, @QueryMap Filters filters);

    @GET("accounts/{projectId}/projectTemplate/{id}")
    Call<ProjectTemplate> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("accounts/{projectId}/projectTemplate")
    Call<ProjectTemplate> create(@Path("projectId") String projectId, @Body ProjectTemplate projectTemplate);

    @PUT("accounts/{projectId}/projectTemplate/{id}")
    Call<ProjectTemplate> update(@Path("projectId") String projectId, @Path("id") String id, @Body ProjectTemplate projectTemplate);

    @DELETE("accounts/{projectId}/projectTemplate/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("accounts/{projectId}/projectTemplate/{id}?action=remove")
