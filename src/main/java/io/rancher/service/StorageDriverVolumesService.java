...
public interface StorageDriverVolumesService {

    @GET("storageDrivers/{projectId}/volume")
    ...
    @POST("storageDrivers/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("storageDrivers/{projectId}/volume/{id}?action=snapshot")
