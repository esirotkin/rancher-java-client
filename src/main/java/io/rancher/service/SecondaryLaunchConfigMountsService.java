...
public interface SecondaryLaunchConfigMountsService {

    @GET("secondaryLaunchConfigs/{projectId}/mount")
    ...
    @GET("secondaryLaunchConfigs/{projectId}/mount/{id}")
    Call<Mount> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("secondaryLaunchConfigs/{projectId}/mount")
    Call<Mount> create(@Path("projectId") String projectId, @Body Mount mount);

    @PUT("secondaryLaunchConfigs/{projectId}/mount/{id}")
    Call<Mount> update(@Path("projectId") String projectId, @Path("id") String id, @Body Mount mount);

    @DELETE("secondaryLaunchConfigs/{projectId}/mount/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("secondaryLaunchConfigs/{projectId}/mount/{id}?action=deactivate")
    Call<Mount> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("secondaryLaunchConfigs/{projectId}/mount/{id}?action=remove")
