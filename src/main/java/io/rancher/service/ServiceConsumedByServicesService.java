...
public interface ServiceConsumedByServicesService {

    @GET("services/{projectId}/service")
    ...
    @POST("services/{projectId}/service/{id}?action=upgrade")
