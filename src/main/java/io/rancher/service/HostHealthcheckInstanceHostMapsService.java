...
public interface HostHealthcheckInstanceHostMapsService {

    @GET("hosts/{projectId}/healthcheckInstanceHostMap")
    ...
    @GET("hosts/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<HealthcheckInstanceHostMap> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("hosts/{projectId}/healthcheckInstanceHostMap")
    ...
    @PUT("hosts/{projectId}/healthcheckInstanceHostMap/{id}")
    ...
    @DELETE("hosts/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("hosts/{projectId}/healthcheckInstanceHostMap/{id}?action=remove")
