...
public interface ContainerServiceService {

    @GET("containers/{projectId}/service")
    ...
    @POST("containers/{projectId}/service/{id}?action=upgrade")
