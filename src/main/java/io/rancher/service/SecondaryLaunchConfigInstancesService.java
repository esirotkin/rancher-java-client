...
public interface SecondaryLaunchConfigInstancesService {

    @GET("secondaryLaunchConfigs/{projectId}/instance")
    ...
    @GET("secondaryLaunchConfigs/{projectId}/instance/{id}")
    Call<Instance> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("secondaryLaunchConfigs/{projectId}/instance")
    Call<Instance> create(@Path("projectId") String projectId, @Body Instance instance);

    @PUT("secondaryLaunchConfigs/{projectId}/instance/{id}")
    Call<Instance> update(@Path("projectId") String projectId, @Path("id") String id, @Body Instance instance);

    @DELETE("secondaryLaunchConfigs/{projectId}/instance/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("secondaryLaunchConfigs/{projectId}/instance/{id}?action=allocate")
    Call<Instance> allocate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("secondaryLaunchConfigs/{projectId}/instance/{id}?action=console")
