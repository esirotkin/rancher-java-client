...
public interface SnapshotVolumeService {

    @GET("snapshots/{projectId}/volume")
    ...
    @POST("snapshots/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("snapshots/{projectId}/volume/{id}?action=snapshot")
