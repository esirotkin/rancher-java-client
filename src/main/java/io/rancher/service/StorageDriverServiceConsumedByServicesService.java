...
public interface StorageDriverServiceConsumedByServicesService {

    @GET("storageDriverServices/{projectId}/service")
    ...
    @GET("storageDriverServices/{projectId}/service/{id}")
    Call<Service> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("storageDriverServices/{projectId}/service")
    Call<Service> create(@Path("projectId") String projectId, @Body Service service);

    @PUT("storageDriverServices/{projectId}/service/{id}")
    Call<Service> update(@Path("projectId") String projectId, @Path("id") String id, @Body Service service);

    @DELETE("storageDriverServices/{projectId}/service/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=activate")
    Call<Service> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=addservicelink")
    ...
    @POST("storageDriverServices/{projectId}/service/{id}?action=cancelupgrade")
    Call<Service> cancelupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=continueupgrade")
    Call<Service> continueupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=deactivate")
    Call<Service> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=finishupgrade")
    Call<Service> finishupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=remove")
    Call<Service> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=removeservicelink")
    ...
    @POST("storageDriverServices/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("storageDriverServices/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("storageDriverServices/{projectId}/service/{id}?action=upgrade")
