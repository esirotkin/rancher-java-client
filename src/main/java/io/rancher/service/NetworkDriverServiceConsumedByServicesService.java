...
public interface NetworkDriverServiceConsumedByServicesService {

    @GET("networkDriverServices/{projectId}/service")
    ...
    @GET("networkDriverServices/{projectId}/service/{id}")
    Call<Service> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("networkDriverServices/{projectId}/service")
    Call<Service> create(@Path("projectId") String projectId, @Body Service service);

    @PUT("networkDriverServices/{projectId}/service/{id}")
    Call<Service> update(@Path("projectId") String projectId, @Path("id") String id, @Body Service service);

    @DELETE("networkDriverServices/{projectId}/service/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=activate")
    Call<Service> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=addservicelink")
    ...
    @POST("networkDriverServices/{projectId}/service/{id}?action=cancelupgrade")
    Call<Service> cancelupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=continueupgrade")
    Call<Service> continueupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=deactivate")
    Call<Service> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=finishupgrade")
    Call<Service> finishupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=remove")
    Call<Service> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=removeservicelink")
    ...
    @POST("networkDriverServices/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("networkDriverServices/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("networkDriverServices/{projectId}/service/{id}?action=upgrade")
