...
public interface ComposeProjectVolumesService {

    @GET("composeProjects/{projectId}/volume")
    ...
    @POST("composeProjects/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("composeProjects/{projectId}/volume/{id}?action=snapshot")
