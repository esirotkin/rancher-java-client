...
public interface InstanceHealthcheckInstanceHostMapsService {

    @GET("instances/{projectId}/healthcheckInstanceHostMap")
    ...
    @GET("instances/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<HealthcheckInstanceHostMap> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("instances/{projectId}/healthcheckInstanceHostMap")
    ...
    @PUT("instances/{projectId}/healthcheckInstanceHostMap/{id}")
    ...
    @DELETE("instances/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("instances/{projectId}/healthcheckInstanceHostMap/{id}?action=remove")
