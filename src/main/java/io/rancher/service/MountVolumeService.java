...
public interface MountVolumeService {

    @GET("mounts/{projectId}/volume")
    ...
    @POST("mounts/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("mounts/{projectId}/volume/{id}?action=snapshot")
