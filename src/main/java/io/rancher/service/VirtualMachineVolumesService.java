...
public interface VirtualMachineVolumesService {

    @GET("virtualMachines/{projectId}/volume")
    ...
    @POST("virtualMachines/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("virtualMachines/{projectId}/volume/{id}?action=snapshot")
