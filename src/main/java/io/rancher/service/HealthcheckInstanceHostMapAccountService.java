...
public interface HealthcheckInstanceHostMapAccountService {

    @GET("healthcheckInstanceHostMaps/{projectId}/account")
    ...
    @GET("healthcheckInstanceHostMaps/{projectId}/account/{id}")
    Call<Account> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("healthcheckInstanceHostMaps/{projectId}/account")
    Call<Account> create(@Path("projectId") String projectId, @Body Account account);

    @PUT("healthcheckInstanceHostMaps/{projectId}/account/{id}")
    Call<Account> update(@Path("projectId") String projectId, @Path("id") String id, @Body Account account);

    @DELETE("healthcheckInstanceHostMaps/{projectId}/account/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/account/{id}?action=activate")
    Call<Account> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/account/{id}?action=deactivate")
    Call<Account> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/account/{id}?action=purge")
    Call<Account> purge(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/account/{id}?action=remove")
    Call<Account> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/account/{id}?action=upgrade")
