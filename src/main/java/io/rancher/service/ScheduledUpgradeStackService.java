...
public interface ScheduledUpgradeStackService {

    @GET("scheduledUpgrades/{projectId}/stack")
    ...
    @POST("scheduledUpgrades/{projectId}/stack/{id}?action=finishupgrade")
    Call<Stack> finishupgrade(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("scheduledUpgrades/{projectId}/stack/{id}?action=remove")
    Call<Stack> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("scheduledUpgrades/{projectId}/stack/{id}?action=rollback")
    Call<Stack> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("scheduledUpgrades/{projectId}/stack/{id}?action=upgrade")
