...
public interface ContainerHealthcheckInstanceHostMapsService {

    @GET("containers/{projectId}/healthcheckInstanceHostMap")
    ...
    @GET("containers/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<HealthcheckInstanceHostMap> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("containers/{projectId}/healthcheckInstanceHostMap")
    ...
    @PUT("containers/{projectId}/healthcheckInstanceHostMap/{id}")
    ...
    @DELETE("containers/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("containers/{projectId}/healthcheckInstanceHostMap/{id}?action=remove")
