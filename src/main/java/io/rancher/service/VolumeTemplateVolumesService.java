...
public interface VolumeTemplateVolumesService {

    @GET("volumeTemplates/{projectId}/volume")
    ...
    @POST("volumeTemplates/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("volumeTemplates/{projectId}/volume/{id}?action=snapshot")
