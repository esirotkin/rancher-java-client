...
public interface SecondaryLaunchConfigHealthcheckInstanceHostMapsService {

    @GET("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap")
    ...
    @GET("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<HealthcheckInstanceHostMap> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap")
    ...
    @PUT("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap/{id}")
    ...
    @DELETE("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("secondaryLaunchConfigs/{projectId}/healthcheckInstanceHostMap/{id}?action=remove")
