...
public interface ComposeProjectServicesService {

    @GET("composeProjects/{projectId}/service")
    ...
    @POST("composeProjects/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("composeProjects/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("composeProjects/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("composeProjects/{projectId}/service/{id}?action=upgrade")
