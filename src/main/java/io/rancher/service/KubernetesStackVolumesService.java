...
public interface KubernetesStackVolumesService {

    @GET("kubernetesStacks/{projectId}/volume")
    ...
    @POST("kubernetesStacks/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("kubernetesStacks/{projectId}/volume/{id}?action=snapshot")
