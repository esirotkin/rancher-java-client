...
public interface DnsServiceConsumedByServicesService {

    @GET("dnsServices/{projectId}/service")
    ...
    @POST("dnsServices/{projectId}/service/{id}?action=upgrade")
