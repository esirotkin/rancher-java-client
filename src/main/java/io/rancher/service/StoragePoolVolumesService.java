...
public interface StoragePoolVolumesService {

    @GET("storagePools/{projectId}/volume")
    ...
    @POST("storagePools/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("storagePools/{projectId}/volume/{id}?action=snapshot")
