...
public interface ContainerRegistryCredentialService {

    @GET("containers/{projectId}/registryCredential")
    ...
    @DELETE("containers/{projectId}/registryCredential/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("containers/{projectId}/registryCredential/{id}?action=activate")
    Call<Credential> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("containers/{projectId}/registryCredential/{id}?action=deactivate")
    Call<Credential> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("containers/{projectId}/registryCredential/{id}?action=purge")
    Call<Credential> purge(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("containers/{projectId}/registryCredential/{id}?action=remove")
