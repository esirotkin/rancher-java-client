...
public interface HealthcheckInstanceHostMapInstanceService {

    @GET("healthcheckInstanceHostMaps/{projectId}/instance")
    ...
    @GET("healthcheckInstanceHostMaps/{projectId}/instance/{id}")
    Call<Instance> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("healthcheckInstanceHostMaps/{projectId}/instance")
    Call<Instance> create(@Path("projectId") String projectId, @Body Instance instance);

    @PUT("healthcheckInstanceHostMaps/{projectId}/instance/{id}")
    Call<Instance> update(@Path("projectId") String projectId, @Path("id") String id, @Body Instance instance);

    @DELETE("healthcheckInstanceHostMaps/{projectId}/instance/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=allocate")
    Call<Instance> allocate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=console")
    ...
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=deallocate")
    Call<Instance> deallocate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=error")
    Call<Instance> error(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=migrate")
    Call<Instance> migrate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=purge")
    Call<Instance> purge(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=remove")
    Call<Instance> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=restart")
    Call<Instance> restart(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=start")
    Call<Instance> start(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=stop")
    Call<Instance> stop(@Path("projectId") String projectId, @Path("id") String id, @Body InstanceStop instanceStop);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=updatehealthy")
    Call<Instance> updatehealthy(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=updatereinitializing")
    Call<Instance> updatereinitializing(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/instance/{id}?action=updateunhealthy")
