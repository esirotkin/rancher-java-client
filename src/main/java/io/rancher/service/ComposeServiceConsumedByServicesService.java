...
public interface ComposeServiceConsumedByServicesService {

    @GET("composeServices/{projectId}/service")
    ...
    @POST("composeServices/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("composeServices/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("composeServices/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("composeServices/{projectId}/service/{id}?action=upgrade")
