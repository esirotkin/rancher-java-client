...
public interface VirtualMachineServicesService {

    @GET("virtualMachines/{projectId}/service")
    ...
    @POST("virtualMachines/{projectId}/service/{id}?action=restart")
    Call<Service> restart(@Path("projectId") String projectId, @Path("id") String id, @Body ServiceRestart serviceRestart);
    
    @POST("virtualMachines/{projectId}/service/{id}?action=rollback")
    Call<Service> rollback(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("virtualMachines/{projectId}/service/{id}?action=setservicelinks")
    ...
    @POST("virtualMachines/{projectId}/service/{id}?action=upgrade")
