...
public interface StackVolumesService {

    @GET("stacks/{projectId}/volume")
    ...
    @POST("stacks/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("stacks/{projectId}/volume/{id}?action=snapshot")
