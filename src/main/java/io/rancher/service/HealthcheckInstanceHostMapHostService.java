...
public interface HealthcheckInstanceHostMapHostService {

    @GET("healthcheckInstanceHostMaps/{projectId}/host")
    ...
    @GET("healthcheckInstanceHostMaps/{projectId}/host/{id}")
    Call<Host> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("healthcheckInstanceHostMaps/{projectId}/host")
    Call<Host> create(@Path("projectId") String projectId, @Body Host host);

    @PUT("healthcheckInstanceHostMaps/{projectId}/host/{id}")
    Call<Host> update(@Path("projectId") String projectId, @Path("id") String id, @Body Host host);

    @DELETE("healthcheckInstanceHostMaps/{projectId}/host/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=activate")
    Call<Host> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=deactivate")
    Call<Host> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=dockersocket")
    Call<HostAccess> dockersocket(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=error")
    Call<Host> error(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=evacuate")
    Call<Host> evacuate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=provision")
    Call<Host> provision(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=purge")
    Call<Host> purge(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("healthcheckInstanceHostMaps/{projectId}/host/{id}?action=remove")
