...
public interface SecondaryLaunchConfigVolumesService {

    @GET("secondaryLaunchConfigs/{projectId}/volume")
    ...
    @POST("secondaryLaunchConfigs/{projectId}/volume/{id}?action=reverttosnapshot")
    ...
    @POST("secondaryLaunchConfigs/{projectId}/volume/{id}?action=snapshot")
