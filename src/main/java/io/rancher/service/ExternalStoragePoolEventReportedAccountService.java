...
public interface ExternalStoragePoolEventReportedAccountService {

    @GET("externalStoragePoolEvents/{projectId}/account")
    ...
    @GET("externalStoragePoolEvents/{projectId}/account/{id}")
    Call<Account> get(@Path("projectId") String projectId, @Path("id") String id);

    @POST("externalStoragePoolEvents/{projectId}/account")
    Call<Account> create(@Path("projectId") String projectId, @Body Account account);

    @PUT("externalStoragePoolEvents/{projectId}/account/{id}")
    Call<Account> update(@Path("projectId") String projectId, @Path("id") String id, @Body Account account);

    @DELETE("externalStoragePoolEvents/{projectId}/account/{id}")
    Call<Response> delete(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("externalStoragePoolEvents/{projectId}/account/{id}?action=activate")
    Call<Account> activate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("externalStoragePoolEvents/{projectId}/account/{id}?action=deactivate")
    Call<Account> deactivate(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("externalStoragePoolEvents/{projectId}/account/{id}?action=purge")
    Call<Account> purge(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("externalStoragePoolEvents/{projectId}/account/{id}?action=remove")
    Call<Account> remove(@Path("projectId") String projectId, @Path("id") String id);
    
    @POST("externalStoragePoolEvents/{projectId}/account/{id}?action=upgrade")
