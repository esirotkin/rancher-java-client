...
public interface ServiceLogServiceService {

    @GET("serviceLogs/{projectId}/service")
    ...
    @POST("serviceLogs/{projectId}/service/{id}?action=upgrade")
